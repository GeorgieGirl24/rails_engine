...
RSpec.describe 'Finds the Invoices with the most expensive revenues' do
  scenario 'returns x number top Invoices with the most expensive totals' do
    ...
    create(:invoice_item, quantity: 5, unit_price: 100.00, invoice_id: invoice1.id, item_id: create(:item, unit_price: 10.00).id)
    # invoice1_total = 500

    invoice2 = create(:invoice, merchant_id: merchant1.id, status: 'shipped')
    create(:transaction, result: 'success', invoice_id: invoice2.id)
    create(:invoice_item, quantity: 7, unit_price: 1_000.00, invoice_id: invoice2.id, item_id: create(:item, unit_price: 10.00).id)
    ...
    create(:invoice_item, quantity: 6, unit_price: 2_000.00, invoice_id: invoice5.id, item_id: create(:item, unit_price: 10.00).id)
    ...
    create(:invoice_item, quantity: 2, unit_price: 10_000.50, invoice_id: invoice6.id, item_id: create(:item, unit_price: 10.00).id)
    # invoice6_total = nil

    invoice7 = create(:invoice, merchant_id: merchant1.id, status: 'shipped')
    create(:transaction, result: 'failed', invoice_id: invoice7.id)
    create(:invoice_item, quantity: 1, unit_price: 7_500.00, invoice_id: invoice7.id, item_id: create(:item, unit_price: 10.00).id)
    ...
    create(:invoice_item, quantity: 100, unit_price: 10.00, invoice_id: invoice8.id, item_id: create(:item, unit_price: 10.00).id)
    ...
    create(:invoice_item, quantity: 105, unit_price: 10.00, invoice_id: invoice9.id, item_id: create(:item, unit_price: 10.00).id)
    ...
    create(:invoice_item, quantity: 100, unit_price: 9.00, invoice_id: invoice10.id, item_id: create(:item, unit_price: 10.00).id)
    # invoice10_total = 900
    ...
    create(:invoice_item, quantity: 100, unit_price: 100.00, invoice_id: invoice11.id, item_id: create(:item, unit_price: 10.00).id)
