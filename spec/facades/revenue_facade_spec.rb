...
RSpec.describe RevenueFacade do
  describe 'class methods' do
    ...
    it '.total_revenue' do
      ...
      invoice6 = create(:invoice, merchant_id: merchant3.id, status: 'packaged', created_at: '2020-06-01T00:00:00 UTC')
      ...
      invoice7 = create(:invoice, merchant_id: merchant4.id, status: 'shipped', created_at: '2020-04-12T00:00:00 UTC')
